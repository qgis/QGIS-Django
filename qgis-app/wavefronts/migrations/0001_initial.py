        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "thumbnail_image",
                    models.ImageField(
                        help_text="Please upload an image that demonstrate this 3D Model",
                        upload_to="wavefronts",
                ...
                (
                    "file",
                    models.FileField(
                        help_text="A 3D model zip file. The zip file must contains obj and mtl files",
                        upload_to="wavefronts",
                        validators=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "resource",
                    models.ForeignKey(
                        help_text="The reviewed Wavefront",
                        on_delete=django.db.models.deletion.CASCADE,
                        to="wavefronts.Wavefront",
                        verbose_name="Wavefront",
                    ),
                ),
                (
                    "reviewer",
                    models.ForeignKey(
                        ...
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="wavefronts_review_related",
                        to=settings.AUTH_USER_MODEL,
