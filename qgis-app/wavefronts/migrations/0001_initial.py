# Generated by Django 2.2.24 on 2021-11-07 22:15
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('thumbnail_image', models.ImageField(help_text='Please upload an image that demonstrate this 3D Model', upload_to='wavefronts', verbose_name='Thumbnail')),
                ('file', models.FileField(help_text='A 3D model zip file. The zip file must contains obj and mtl files', upload_to='wavefronts', validators=[django.core.validators.FileExtensionValidator(allowed_extensions=['zip'])], verbose_name='3D Model file')),
