...
urlpatterns = [
    ...
    path('<int:pk>/delete/', LayerDefinitionDeleteView.as_view(),
         name='layerdefinition_delete'),
    path('<int:pk>/review/', LayerDefinitionReviewView.as_view(),
         name='layerdefinition_review'),
    path('<int:pk>/download/', LayerDefinitionDownloadView.as_view(),
