...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PluginVersion.changelog'
        db.alter_column('plugins_pluginversion', 'changelog', self.gf('django.db.models.fields.TextField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'PluginVersion.changelog'
        db.alter_column('plugins_pluginversion', 'changelog', self.gf('django.db.models.fields.TextField')(default=datetime.date(2011, 12, 7)))
